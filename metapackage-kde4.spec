...
Requires:	kde4-kdepim >= 4.4.5
Requires:	kde4-kdepim-akregator >= 4.4.5
Requires:	kde4-kdepim-kaddressbook >= 4.4.5
Requires:	kde4-kdepim-kmail >= 4.4.5
Requires:	kde4-kdepim-knode >= 4.4.5
Requires:	kde4-kdepim-kontact >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-akregator >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-kaddressbook >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-kmail >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-knode >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-korganizer >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-planner >= 4.4.5
Requires:	kde4-kdepim-kontact-plugin-summary >= 4.4.5
Requires:	kde4-kdepim-libs >= 4.4.5
Requires:	kde4-kdepim-runtime >= 4.4.5
#
